      ...
      <div className="w-full h-full flex flex-col justify-center items-center text-center">
        <div className="w-full text-foreground flex flex-col justify-center items-center gap-8 md:flex-row">
          <div className="flex flex-col gap-y-4">
            <div className="flex">
              <Tooltip content="Particulate Matter">
                <CircularProgress
            ...
            <div className="flex">
              <Tooltip content="Sulfur dioxide">
                <CircularProgress
          ...
          <div>
            <Tooltip content="Air Quality Index">
              <CircularProgress
                value={airQualityData.main.aqi}
                minValue={0}
                maxValue={5}
          ...
          <div className="flex flex-col gap-y-4">
            <div className="flex">
              <Tooltip content="Carbon monoxide">
                <CircularProgress
            ...
            <div className="flex">
              <Tooltip content="Nitrogen dioxide">
                <CircularProgress
